                ...
                <Row className="mb-3">
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <Form.Control type="number" name="loanTerm" value={formData.loanTerm} onChange={handleChange} placeholder="E.g., 60" min="12" max="84" required />
                    </Form.Group>
                  </Col>
                </Row>
                ...
                <Row className="mb-3">
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <Form.Control type="number" name="age" value={formData.age} onChange={handleChange} placeholder="E.g., 30" min="18" max="70" required />
                    </Form.Group>
                  </Col>
                </Row>
